...
function ProfileCardComponent({
  ...
  const hideBrokenAvatar = useCallback(() => {
  ...
  useEffect(() => {
    ...
    const handleClick = () => {
      ...
      const motionEventCtor = window.DeviceMotionEvent as unknown as {
        requestPermission?: () => Promise<"granted" | "denied">;
      };
      if (motionEventCtor && typeof motionEventCtor.requestPermission === "function") {
        motionEventCtor
          .requestPermission()
          .then((state) => {
            if (state === "granted") {
