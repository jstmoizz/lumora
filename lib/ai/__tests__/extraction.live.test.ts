/**
 * Live-model check that extraction works end to end against the real Groq
 * API — the one thing mocked tests can't prove. Opt-in only (real quota
 * usage, non-deterministic), not part of the default `vitest run`:
 *
...
// A real, decodable 64x64 PNG — the 2x2 fixture used elsewhere is too small
// for the real API, which rejects it as "invalid image data."
